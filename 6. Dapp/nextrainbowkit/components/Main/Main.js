...
import Contract from "../../artifacts/contracts/SimpleStorage.json";

const Main = () => {
  const { address, isConnected } = useAccount();
  const contractAddress = "0x5FbDB2315678afecb367f032d93F642f64180aa3"; //change to real goerli address
      ...
      {isConnected ? (
        <Flex direction="column" width="100%">
          <Flex>
            ...
            />
            <Button onClick={() => setFavoriteNumber()} colorScheme="purple">
              Set Favorite Number
            </Button>
          </Flex>
